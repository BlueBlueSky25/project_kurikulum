            ...
            <div class="bg-paper border border-rule">
                ...
                <form action="{{ route('peminjaman.guest.store') }}" method="POST" id="peminjamanForm" class="px-6 py-6 space-y-6">
                    ...
                    <div class="bg-cream border border-rule">
                        ...
                        {{-- Content (Collapsible) --}}
                        <div id="items-container" style="display: none;" class="px-4 py-3 border-t border-rule space-y-2">
                            {{-- Scan Button --}}
                            <button
                                type="button"
                                id="qr_scanner_btn"
                                class="w-full px-3 py-2.5 bg-espresso text-paper font-sans text-[0.7rem] font-semibold tracking-[0.1em] uppercase
                                       hover:bg-ink transition-all duration-200
                                       flex items-center justify-center gap-2"
                            >
                                <i class="fas fa-camera text-[0.75rem]"></i>
                            ...
                            <p id="qr_status" class="font-sans text-[0.62rem] text-label text-center"></p>
                        </div>
                    </div>
                ...
                <div class="px-6 py-6 space-y-8 overflow-y-auto flex-1">
                    ...
                    <div>
                        ...
                        <ol class="font-sans text-[0.7rem] text-label space-y-2 ml-8">
                            <li>1. Isi data guru dengan benar</li>
                            <li>2. Pilih kelas dan mata pelajaran</li>
                            <li>3. Tentukan jam mulai dan kembali</li>
                            <li>4. Scan QR barang yang dipinjam</li>
                            <li>5. Klik "Ajukan Peminjaman"</li>
                        </ol>
                    </div>
                    ...
                    <div>
                        <div class="flex items-center gap-2 mb-4">
                            <div class="w-6 h-6 bg-espresso text-paper flex items-center justify-center rounded-full">
                                <i class="fas fa-qrcode text-[0.6rem]"></i>
                            </div>
                            <h4 class="font-serif text-ink text-base font-normal">Cara Scan QR</h4>
                        </div>
                        <ol class="font-sans text-[0.7rem] text-label space-y-2 ml-8">
                            <li>1. Buka section "Barang yang Dipinjam"</li>
                            <li>2. Klik tombol "Scan QR Barang"</li>
                            <li>3. Arahkan kamera ke QR code</li>
                            <li>4. Ulangi untuk barang lainnya</li>
                        </ol>
                    </div>
                    ...
                    <div>
                        <div class="flex items-center gap-2 mb-4">
                            ...
                            <h4 class="font-serif text-ink text-base font-normal">Jam Pelajaran</h4>
                        </div>
                        <p class="font-sans text-[0.7rem] text-label ml-8">Peminjaman hanya dapat dilakukan pada jam pelajaran sesuai jadwal sekolah. Pastikan waktu kembali lebih besar dari waktu mulai.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="font-sans text-[0.7rem] text-label space-y-1.5 ml-8">
                            ...
                            <li>• Barang dikembalikan tepat waktu</li>
                            <li>• Alat harus dalam kondisi baik</li>
                            <li>• Ada denda untuk keterlambatan</li>
                        </ul>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function toggleItemsList() {
        ...
        listIcon.style.transform = isHidden ? 'rotate(90deg)' : 'rotate(0deg)';
    }
    ...
    function processQrData(qrData) {
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                if (exists) {
                    qrStatus.textContent = '⚠️ Unit ini sudah di-scan!';
    ...
    function renderScannedItems() {
        ...
        scannedUnits.forEach((unit, index) => {
            html += `
                <div class="bg-sand px-3 py-2.5 rounded flex items-center justify-between hover:bg-sand/80 transition-colors">
                    <div class="flex-1 min-w-0">
                        <p class="font-sans text-[0.68rem] font-semibold text-ink truncate">
                            ${unit.nama_alat}
                        </p>
                        <p class="font-sans text-[0.6rem] text-label">
                    ...
                    <button
                        ...
                        class="ml-2 px-2 py-1 bg-espresso text-paper text-[0.5rem] font-semibold
                               hover:bg-ink transition-all flex-shrink-0 rounded"
                    >
